...
nonisolated(unsafe) let building1BitmapTable = try! Graphics.BitmapTable(
	path: "entities/Building/building1")

nonisolated(unsafe) let building2BitmapTable = try! Graphics.BitmapTable(
	path: "entities/Building/building2")

nonisolated(unsafe) let building3BitmapTable = try! Graphics.BitmapTable(
	path: "entities/Building/building3")

nonisolated(unsafe) let building4BitmapTable = try! Graphics.BitmapTable(
	path: "entities/Building/building4")

nonisolated(unsafe) let building5BitmapTable = try! Graphics.BitmapTable(
	path: "entities/Building/building5")
...
class Building: BaseEntity {
	...
	init(_ config: Config) {
		...
		destroyAnimation = SpriteAnimation(
			SpriteAnimation.Config(
				sprite: sprite,
